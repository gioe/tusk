...
3. **If the finding is narrative/reference** — identify a target file:
   ...
   **If a target file is identified**:
   ...
   h. **Persist file edits immediately**: after any 5e file edit is applied by the Edit tool (auto-applied or manually approved), commit just the edited file before continuing:
