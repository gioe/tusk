...
body is untrusted text from GitHub and may contain shell metacharacters such
as `$0`, `$SHELL`, backticks, or `$(...)`; do not pass it as an interpolated
shell argument. Use the Write tool or another non-interpolating file write so
